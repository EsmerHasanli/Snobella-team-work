...
//   console.log(basketCalculateWrapper);
...
//               ).length;
//               basketCalculateWrapper.innerHTML += `
//                   <div class="basket-calculate-title">
//                   <div class="price">
//                       <span>Your substotal</span>
//                       <span>US <span class="product-price">$${subTotal}</span></span>
//                   </div>
//                   <div class="free">
//                       <span>Shipping changes</span>
//                       <span>Free</span>
//                   </div>
//                   <div class="total-price">
//                       <span>Total</span>
//                       <span>US <span>$${subTotal}</span></span>
//                   </div>
//                   <div class="line"></div>
...
//                   <button><span>Confirm cart</span></button>
//               </div>
//           `;
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  if (baskets) {
    ...
    baskets.forEach((basketProduct) => {
      ...
      // updateBasketCalculations(subTotal);
    });
  }

  // function updateBasketCalculations(subTotal) {
  //   basketCalculateWrapper.innerHTML = `
  //     <div class="basket-calculate-title">
  //       <div class="price">
